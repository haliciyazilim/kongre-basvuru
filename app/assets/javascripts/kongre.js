...
kongreApp.controller('registerFormController', ['$scope', '$http', '$document', '$timeout', '$log', '$modal', 'Notification', function ($scope,
                                                                                                                                        $http,
                                                                                                                                        $document,
                                                                                                                                        $timeout,
                                                                                                                                        $log,
    ...
    $scope.setAttendance = function (attendance, add) {
        ...
        $scope.form.applicant.previous_attendances = (calculatePreviousAttendance($scope.attendances));
    ...
    $scope.refreshTotalAmount = function () {
        ...
        $scope.totalAmount = $scope.form.applicant.applicant_category == 'instructor_student' ? 10000 : 13000;
    ...
    $scope.couponCheck = function (code) {
        ...
        $http.get('/coupon_check', {params: {code: $scope.form.couponCode, email: $scope.form.applicant.email}})
        .then(
          function(response){
